		...
		<div class="p-5  mb-5 bg-white container1">
			<!-- 첫번째 박스 구역 (휴대전화 인증, 이메일 인증)-->
				...
				<div class="form-check ">
					<!-- 휴대전화로 인증 구역-->
					<form action="findIdP.m" method="get">
						...
						<div class="row px-1 py-4 ">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" name="inputName"
									id="c1_inputName" placeholder="이름을 입력해주세요" required>
							</div>
						</div>
						<!--이름 끝-->
						...
						<div class="row px-1 py-2">
							...
							<div class="col-sm-2">
								<input type="text" class="form-control" name="inputNum2"
									id="c1_inputNum2" placeholder="전화번호 4자리" minlength="4 "maxlength="4"
									required="required">
							</div>
							<div class="col-sm-3">
							...
							<div
								...
								<div class="modal-content text-center p-2">
									<div class="modal-header">
										<h5 class="modal-title fw-bold">아이디 찾기</h5>
										<button type="button" class="btn-close"
											data-bs-dismiss="modal" aria-label="Close"></button>
									</div>
									<div class="modal-body p-5">
										<div class="row">
											<div class="mb-3 col-sm-12 pb-4 text-center">
												<span class="form-label">당신의 아이디는 ${FOUNDID }입니다.</span>
											</div>
											<div class="mb-3 col-sm-12">
												<button type="button" class="btn btn-secondary"
													type="submit" style="width: 90%;">
													<a href="login.jsp"
														class="text-decoration-none text-white">로그인하러가기</a>
												</button>
											</div>
										</div>
									</div>
				...
				<div class="form-check">
					...
					<div class="certification" id="display2">
						...
						<div class="row px-1 py-2">
							<!--이름-->
							<div class="col-sm-2">
								<label for="inputName" class="form-label mt-1" required>이름</label>
							</div>
							<div class="col-sm-4">
								<input type="text" class="form-control" name="inputName"
									id="c2_inputName" placeholder="이름을 입력해주세요" required>
							</div>
						</div>
						<!--이름 끝-->
						<div class="row px-1 py-2">
							...
							@
							<div class="col-sm-3">
								<select id="c2_selectEmail" name="selectEmail" class="form-select">
							...
							<div
								...
								<div class="modal-content text-center p-2">
									...
									<div class="modal-body p-5">
										<div class="row">
											<div class="mb-3 col-sm-12 pb-4 text-center">
												<span class="form-label">당신의 아이디는 ${FOUNDIDE }입니다.</span>
											</div>
											<div class="mb-3 col-sm-12">
												<button type="button" class="btn btn-secondary"
													type="submit" style="width: 90%;">
