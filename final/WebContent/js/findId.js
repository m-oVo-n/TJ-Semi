...
$(document).ready(function () {
    // 클릭 이벤트 처리
    $('.form-check-input').eq(2).on('click', function () {
        $('.certification#display3').toggle('certification');
    });
});

$(document).ready(function () {
    // 클릭 이벤트 처리
    $('.form-check-input').eq(3).on('click', function () {
        $('.certification#display4').toggle('certification');
    });
});
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function checkInputs() {
        var c1_inputName = document.getElementById('c1_inputName').value.trim();
        ...
        c1_verifyButton.disabled = !(c1_inputName !== '' && c1_inputNum1 !== '' && c1_inputNum2 !== ''&&c1_inputNum2.length==4);
        
        //이름과 이메일아이디 입력상태 확인 함수
        var  c2_inputName=document.getElementById('c2_inputName').value.trim();
        ...
        c2_verifyButton.disabled = !(c2_inputName !== '' && c2_inputEmailId !== '' &&c2_selectEmail !== '');
    ...
    // 이름과 휴대전화 번호 입력 시 이벤트 처리
    var c1_inputNameElement = document.getElementById('c1_inputName');
    var c1_inputNum1Element = document.getElementById('c1_inputNum1');
    var c1_inputNum2Element = document.getElementById('c1_inputNum2');

    c1_inputNameElement.addEventListener('input', checkInputs);
    ...
    //c2도 동일하게 이름 이메일 입력시 이벤트 처리
    var c2_inputNameElement = document.getElementById('c2_inputName');
    var c2_inputEmailIdElement = document.getElementById('c2_inputEmailId');

    c2_inputNameElement.addEventListener('input', checkInputs);
